...
@router.get(
    "/tilesets/",
    response_model=TilesetListResponse,
...
@router.get(
    "/tilesets/{uuid}/",
    response_model=TilesetPublic,
    summary="Retrieve a specific tileset"
)
...
@router.get(
    "/tileset_info/",
    response_model=TilesetInfoResponse,
    summary="Get detailed metadata for tilesets"
)
...
@router.get(
    "/tiles/",
    response_model=TilesDataResponse,
    summary="Fetch tile data for tilesets"
)
async def get_tiles(
